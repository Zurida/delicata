    ...
    async function getIcon() {
      try {
        const iconsImport = /* @__PURE__ */ Object.assign({
          "/assets/icons/arrow-left.svg": () => import('./arrow-left-DIr3mdmT.mjs').then((m) => m["default"]),
          "/assets/icons/clock.svg": () => import('./clock-Z3e2x8UG.mjs').then((m) => m["default"]),
          "/assets/icons/close.svg": () => import('./close-DufDY9KS.mjs').then((m) => m["default"])
        });
...
//# sourceMappingURL=nuxt-icon-w-vSMVtT.mjs.map
