import { useSSRContext, defineComponent, ref, mergeProps, unref, withAsyncContext, withCtx, createTextVNode } from 'vue';
...
import { _ as __nuxt_component_0$2 } from './VButton-gXoB32oK.mjs';
import { _ as _sfc_main$4 } from './Tag-D89awVA-.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<a${ssrRenderAttrs(mergeProps({
        href: _ctx.to,
        class: "card"
      }, _attrs))} data-v-da473f56><div class="card__image" data-v-da473f56></div><div class="card__description" data-v-da473f56><div class="card__date" data-v-da473f56>\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u043E: ${ssrInterpolate(unref(formatDate)(_ctx.card.createdAt))}</div><h3 class="card__title"${ssrRenderAttr("title", _ctx.card.title)} data-v-da473f56>${ssrInterpolate(_ctx.card.title)}</h3><div class="card__tags" data-v-da473f56><!--[-->`);
      ssrRenderList(_ctx.card.tags, (tag) => {
        _push(ssrRenderComponent(_component_CommonTag, {
          key: tag,
          tag
        }, null, _parent));
      });
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-da473f56"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CommonVButton = __nuxt_component_0$2;
...
//# sourceMappingURL=index-B0e22wqX.mjs.map
