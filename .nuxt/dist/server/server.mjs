import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, watch, nextTick, computed, onScopeDispose, toRefs, defineAsyncComponent, defineComponent, provide, Suspense, mergeProps, Transition, Fragment, withAsyncContext, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/create-DLQ7mHbG.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-B0e22wqX.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-BS5L6CsW.js")
  },
  {
    name: "recipe-id",
    path: "/recipe/:id()",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/_id_-D7gFTIjJ.js")
  }
];
...
const LazyNuxtIcon = defineAsyncComponent(() => import("./_nuxt/nuxt-icon-w-vSMVtT.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  recipe: () => import("./_nuxt/recipe-DKWR50sO.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CbL3UyXk.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-B-0bRRpN.js"));
